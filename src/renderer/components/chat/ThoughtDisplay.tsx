...
const ThoughtDisplay: React.FC<ThoughtDisplayProps> = ({
  ...
  if (running && !thought?.subject) {
    return (
      <div
        className='relative z-1 self-start w-fit max-w-320px mb--12px pb-18px px-10px py-7px rd-t-18px text-13px lh-18px text-t-primary flex items-center gap-8px'
  ...
  return (
    <div
      className='relative z-1 self-start w-fit max-w-360px mb--12px pb-18px px-10px py-7px rd-t-18px text-13px lh-18px text-t-primary'
      style={containerStyle}
    >
