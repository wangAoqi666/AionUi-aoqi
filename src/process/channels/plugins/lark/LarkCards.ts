...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: '智能体工厂 Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        tag: 'markdown',
        content: [
          'Please pair your account with 智能体工厂:',
          '',
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          '1. Open 智能体工厂 settings',
    ...
    elements: [
      {
        ...
        content: [
          ...
          `**Pairing Code:** \`${pairingCode}\``,
          '',
          'Please approve in 智能体工厂 settings:',
          '1. Open 智能体工厂 app',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ 智能体工厂 Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with 智能体工厂 via Lark.',
          '',
          '**Common Actions:**',
