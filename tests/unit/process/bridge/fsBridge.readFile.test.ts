  ...
  return {
    ipcBridge: {
      fs: {
        ...
        readProjectFile: makeProvider('readProjectFile'),
        writeProjectFile: makeProvider('writeProjectFile'),
        ensureProjectFiles: makeProvider('ensureProjectFiles'),
        readMcpJsonFile: makeProvider('readMcpJsonFile'),
        writeMcpJsonFile: makeProvider('writeMcpJsonFile'),
      },
